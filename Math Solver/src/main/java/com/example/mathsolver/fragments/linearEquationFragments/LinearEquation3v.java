...
public class LinearEquation3v extends Fragment {

    private EditText field_x1, field_x2, field_x3, field_y1, field_y2, field_y3, field_z1, field_z2, field_z3, field_c1, field_c2, field_c3;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_linear_equation_3v, container, false);
    }
    ...
    private void initialize(@NotNull View view) {
        field_x1 = view.findViewById(R.id.text_x1_le_3v);
        field_x2 = view.findViewById(R.id.text_x2_le_3v);
        field_x3 = view.findViewById(R.id.text_x3_le_3v);
        field_y1 = view.findViewById(R.id.text_y1_le_3v);
        field_y2 = view.findViewById(R.id.text_y2_le_3v);
        field_y3 = view.findViewById(R.id.text_y3_le_3v);
        field_z1 = view.findViewById(R.id.text_z1_le_3v);
        field_z2 = view.findViewById(R.id.text_z2_le_3v);
        field_z3 = view.findViewById(R.id.text_z3_le_3v);
        field_c1 = view.findViewById(R.id.text_c1_le_3v);
        field_c2 = view.findViewById(R.id.text_c2_le_3v);
        field_c3 = view.findViewById(R.id.text_c3_le_3v);
        text_answer = view.findViewById(R.id.text_answer_le_3v);
        submit_button = view.findViewById(R.id.sumbit_button_le_3v);
        reset_button = view.findViewById(R.id.reset_button_le_3v);
    }
    ...
    private void solve_simple() {
        ...
        RealMatrix coefficients = new Array2DRowRealMatrix(new double[][]{
                ...
                {field_x2_value, field_y2_value, field_z2_value},
                {field_x3_value, field_y3_value, field_z3_value}}
        );
        DecompositionSolver solver = new LUDecomposition(coefficients).getSolver();
        RealVector solution = solver.solve(new ArrayRealVector(new double[]{field_c1_value, field_c2_value, field_c3_value}, false));
        var X = Math.round(solution.getEntry(0) * 100) / 100.0;
        var Y = Math.round(solution.getEntry(1) * 100) / 100.0;
        var Z = Math.round(solution.getEntry(2) * 100) / 100.0;
        text_answer.setText("""
                X: $X
                Y: $Y
                Z: $Z"""
