        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            switch (item.getItemId()) {
                case R.id.nav_determinant ->
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new DeterminantFragment()).commit();
                case R.id.nav_home ->
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new HomeFragment()).commit();
                case R.id.nav_linear_equation ->
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new LinearEquationFragment()).commit();
                case R.id.nav_about -> {
